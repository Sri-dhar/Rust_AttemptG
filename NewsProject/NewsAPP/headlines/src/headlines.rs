...
const GO_ORANGE: Color32 = Color32::from_rgb(123,237,252);
...
impl Headlines {
    ...
    pub fn render_news_cards(&self, ui: &mut eframe::egui::Ui) {
        for a in &self.articles {
            ...
            if self.config.dark_mode {
                ui.style_mut().visuals.hyperlink_color = GO_ORANGE;
            } else {
        ...
        if let Some(rx) = &self.news_rx {
            match rx.try_recv() {
                ...
                Err(_e) => {
                    ...
                    // if you want to see error logs , Uncomment the above line and
                    // change _e to e in Err() 
                }
            }
        }
    }
